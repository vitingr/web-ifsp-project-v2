...
export const QuestionItem: React.FC<QuestionItemProps> = ({ copy }) => {
  ...
  return (
    <button
      className={`flex w-full cursor-pointer flex-col justify-center rounded-sm border border-neutral-300 bg-white p-3 ring-1 ring-neutral-400 duration-default hover:border-green-600 hover:ring-green-600 lg:items-start lg:p-4`}
